...
function feel_drag_over(target, dragover) {
    ...
    return util.call(Config.ondragover, this, target, dragover, start)
}

function hover_drag(target, dragOver) {
    util.call(Config.ondraghover, this, target, dragOver);
}
...
function mouse_drag_over(evt) {
    ...
    let oDragOver = dragInfo.over,
        dragOver = feel_drag_over.call(this, target, oDragOver, dragInfo.start);
    if (oDragOver) {
        if (dragOver) {
            Timeout.add({
                handler: hover_drag,
                context: this,
                args: [target, dragOver],
